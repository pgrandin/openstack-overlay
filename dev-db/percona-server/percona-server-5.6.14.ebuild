...
MY_PV="${PV/_r*}"
PERCONA_RELEASE="62.0"
PERCONA_PV="Percona-Server-$MY_PV-rel$PERCONA_RELEASE"
# keep this in sync with percona
PERCONA_MYSQL_VERSION_EXTRA="62"

inherit versionator
MIRROR_PV=$(get_version_component_range 1-2 ${PV})
SERVER_URI="http://www.percona.com/redir/downloads/Percona-Server-$MIRROR_PV/$PERCONA_PV/source/$PERCONA_PV.tar.gz"
