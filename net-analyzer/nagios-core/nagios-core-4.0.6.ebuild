...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/nagios-core/nagios-core-3.5.1.ebuild,v 1.9 2014/01/26 03:31:14 creffett Exp $
...
#src_prepare() {
#	epatch "${FILESDIR}/nagios-3.5.1-htmlmakefile.patch"
...
src_install() {
	...
	emake DESTDIR="${D}" install-exfoliation
